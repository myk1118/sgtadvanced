class Student{
	...
	*/
    render(){
        ...
        this.domElements.deleteButton = $("<button>").text('delete').click(this.handleDelete);
        this.domElements.operations = $("<td>").append(this.domElements.deleteButton);
        this.domElements.row = $("<tr>").append(this.domElements.name, this.domElements.course, this.domElements.grade, this.domElements.operations);
        return this.domElements.row;
        // return $("#displayArea").append(this.domElements.row);
    }
